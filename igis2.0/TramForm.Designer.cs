namespace igis2._0
{
    partial class TramForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "ТРАМВАЙ 🚋";
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(499, 574);
			this.button3.Name = "button3";
			this.button3.Size = new System.Drawing.Size(274, 23);
			this.button3.TabIndex = 4;
			this.button3.Text = "Сортировка по расстоянию маршрута";
			...
			this.button4.Text = "Узнать прибыль за день";
